...
- Cletus: Men who think crying is weakness (southern comedian, tractor talks)
- Penny: Traditional southern women (told how it's gonna be, no questions)

Principle: "if it's their specialty, they need to be on point with it"
Mission: "I don't wanna miss anyone. Everyone has a safe place."
"""
...
class SpecialistOrchestrator:
    ...
    SPECIALISTS = {
        ...
        'cletus': {
            'name': 'Cletus',
            'specialty': 'Men who think crying is weakness (toxic masculinity, emotional suppression)',
            'triggers': [
                # Masculinity and emotional suppression
                r'\b(man up|be a man|men don\'t cry)\b',
                r'\b(weak|weakness|soft|emotional)\b',
                r'\b(toughen up|suck it up|deal with it)\b',
                
                # Rural/southern/working-class markers
                r'\b(tractor|farm|ranch|field)\b',
                r'\b(hunt|fishing|work with my hands)\b',
                r'\b(never talk about|don\'t discuss|keep it in)\b',
                
                # Generational teaching
                r'\b(my dad never|my father said|raised to)\b',
                r'\b(what happened.*country|division|politics)\b',
                r'\b(provide|provider|breadwinner)\b',
                
                # Hidden grief
                r'\b(can\'t show|won\'t let|have to be strong)\b',
                r'\b(for my family|for my kids|for my wife)\b',
                r'\b(nobody understands|alone in this)\b',
            ],
            'community': 'Men who were taught crying is weakness - rural, working-class, traditional masculinity'
        },
        
        'penny': {
            'name': 'Penny',
            'specialty': 'Traditional southern women (told how it\'s gonna be, no choice)',
            'triggers': [
                # Traditional expectations
                r'\b(told me how|supposed to be|that\'s how it is)\b',
                r'\b(my role|my place|my duty)\b',
                r'\b(married young|married at|got married)\b',
                
                # Suppressed identity
                r'\b(never asked|didn\'t choose|had to)\b',
                r'\b(my husband|my marriage|my family)\b',
                r'\b(what I wanted|what I dreamed|used to be)\b',
                
                # Southern/traditional culture
                r'\b(church|congregation|community)\b',
                r'\b(proper|ladylike|respectable)\b',
                r'\b(raised to|taught to|learned to)\b',
                
                # Grief for lost self
                r'\b(who am I|lost myself|forgot)\b',
                r'\b(always for them|never for me|gave up)\b',
                r'\b(too late|wasted|regret)\b',
            ],
            'community': 'Traditional southern women who were told how their lives would be, no questions asked'
        },
    }
    ...
    def _get_supporting_specialists(self, primary_match: SpecialistMatch) -> List[str]:
        ...
        # Example: Traditional woman + DV might involve both Penny and Siera
        return []
...
if __name__ == '__main__':
    ...
    test_messages = [
        ...
        ("Men don't cry. I was raised to be strong. But I'm alone in this.", None),
        ("I married young. Told how it's gonna be. Lost myself.", None),
        ("Out on the tractor all day. My dad never talked about feelings. Man up, he said.", None),
    ]
